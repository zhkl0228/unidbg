        ...
        if ("libsystem_c.dylib".equals(libraryName)) {
        ...
        } else if ("libsystem_malloc.dylib".equals(libraryName)) {
            {
                ...
                if (log.isDebugEnabled()) {
                    ...
                    Dyld32.log.debug("checkHook symbolName=" + symbolName + ", old=0x" + Long.toHexString(old) + ", libraryName=" + libraryName);
                }
            }
                        ...
                        protected HookStatus hook(Unicorn u, Emulator emulator) {
                            ...
                            if (size <= LARGE_THRESHOLD) {
                                ...
                                if (log.isDebugEnabled()) {
                                    ...
                                    Dyld32.log.debug("Fake _malloc size=" + size);
                                }
                        ...
                        protected HookStatus hook(Unicorn u, Emulator emulator) {
                            ...
                            if (size <= LARGE_THRESHOLD) {
                                ...
                                if (log.isDebugEnabled()) {
                                    ...
                                    Dyld32.log.debug("Fake _valloc size=" + size);
                                }
                                u.reg_write(ArmConst.UC_ARM_REG_R0, LARGE_THRESHOLD + 1);
                            }
                            return HookStatus.RET(u, old);
                        ...
                        protected HookStatus hook(Unicorn u, Emulator emulator) {
                            ...
                            if (size <= LARGE_THRESHOLD) {
                                ...
                                if (log.isDebugEnabled()) {
                                    ...
                                    Dyld32.log.debug("Fake _realloc pointer=" + pointer + ", size=" + size);
                                }
                        ...
                        protected HookStatus hook(Unicorn u, Emulator emulator) {
                            ...
                            if (count * size <= LARGE_THRESHOLD) {
                                ...
                                if (log.isDebugEnabled()) {
                                    ...
                                    Dyld32.log.debug("Fake _calloc count=" + count + ", size=" + size);
                                }
                        ...
                        protected HookStatus hook(Unicorn u, Emulator emulator) {
                            ...
                            if (size <= LARGE_THRESHOLD) {
                                ...
                                if (log.isDebugEnabled()) {
                                    ...
                                    Dyld32.log.debug("Fake _malloc_zone_malloc zone=" + zone + ", size=" + size);
                                }
                                u.reg_write(ArmConst.UC_ARM_REG_R1, LARGE_THRESHOLD + 1);
                            }
                            return HookStatus.RET(u, old);
                        ...
                        protected HookStatus hook(Unicorn u, Emulator emulator) {
                            ...
                            if (count * size <= LARGE_THRESHOLD) {
                                ...
                                if (log.isDebugEnabled()) {
                                    ...
                                    Dyld32.log.debug("Fake _malloc_zone_calloc zone=" + zone + ", count=" + count + ", size=" + size);
                                }
                        ...
                        protected HookStatus hook(Unicorn u, Emulator emulator) {
                            ...
                            if (size <= LARGE_THRESHOLD) {
                                ...
                                if (log.isDebugEnabled()) {
                                    ...
                                    Dyld32.log.debug("Fake _malloc_zone_valloc zone=" + zone + ", size=" + size);
                                }
                                u.reg_write(ArmConst.UC_ARM_REG_R1, LARGE_THRESHOLD + 1);
                            }
                            return HookStatus.RET(u, old);
                        ...
                        protected HookStatus hook(Unicorn u, Emulator emulator) {
                            ...
                            if (size <= LARGE_THRESHOLD) {
                                ...
                                if (log.isDebugEnabled()) {
                                    ...
                                    Dyld32.log.debug("Fake _malloc_zone_memalign zone=" + zone + ", alignment=" + alignment + ", size=" + size);
                                }
                                u.reg_write(ArmConst.UC_ARM_REG_R2, LARGE_THRESHOLD + 1);
                            }
                            return HookStatus.RET(u, old);
